...
#ifndef PLPSLAM_DATA_LANDMARK_H
#define PLPSLAM_DATA_LANDMARK_H
...
namespace PLPSLAM
{
    namespace data
    {
        ...
        public:
            ...
            // FW: 3D point is observable by a frame (isInFrustum), but not necessarily have a 2D match
            void increase_num_observable(unsigned int num_observable = 1);
            // FW: 3D point is observed with a 2D match
            void increase_num_observed(unsigned int num_observed = 1);
            // FW: used in local_map_cleaner::remove_redundant_landmarks()
            ...
            //-----------------------------------------
            // FW:
            Plane *get_Owning_Plane() const;
            void set_Owning_Plane(Plane *owning_pl);
        ...
        private:
            ...
            //-----------------------------------------
            // FW:
            Plane *_mOwningPlane = nullptr;
        };

    } // namespace data
} // namespace PLPSLAM

#endif // PLPSLAM_DATA_LANDMARK_H
