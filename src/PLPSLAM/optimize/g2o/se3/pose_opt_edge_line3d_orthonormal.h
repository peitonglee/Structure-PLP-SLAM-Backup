            ...
            namespace se3
            {
                ...
                public:
                    ...
                    void computeError() override
                    {
                        ...
                        Vec3_t proj = cam_project(pose_keyframe_SE3Quat, _pos_w); // re-projected line function (ax+by+c=0), 投影点(u,v)
                    ...
                    inline Vec3_t cam_project(const ::g2o::SE3Quat &cam_pose_cw, const Vec6_t &plucker_coord)
                    {
                        ...
                        // T_cw = [R_cw, [t_cw]_x R_cw, 0, R_cw]
                        // R_cw: rotation matrix from world to camera
                        // t_cw: translation vector from world to camera
                        // [t_cw]_x]: skew Antisymmetric matrix of t_cw
                        // transformation_line_cw: plucker coordinate transformation from camera coordinate system to world coordinate system
                        ...
                        // return: re-projected line function (ax+by+c=0), a,b,c are the coefficients of the line function
